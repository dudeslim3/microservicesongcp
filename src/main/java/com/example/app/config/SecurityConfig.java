 ...
 * @EnableWebSecurity
 * 
 * @EnableGlobalMethodSecurity(jsr250Enabled = true) public class SecurityConfig
 * extends KeycloakWebSecurityConfigurerAdapter {
 * 
 * @Override protected void configure(HttpSecurity http) throws Exception {
 * super.configure(http);
 * http.authorizeRequests().antMatchers().hasAnyRole("emigrant") //
 * .antMatchers().hasAnyRole("public")
 * 
 * .antMatchers().hasAnyRole("recruiting agent").antMatchers().
 * hasAnyRole("foreign employer")
 * 
